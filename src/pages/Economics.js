...
const DEPT_COLOR = '#2E7D32'; // Growth Green
const DEPT_NAME = 'Economics';
...
const quickLinks = [ "BSc in Economics", "Economic Research Bureau", "Policy Debate Forum", "Academic Calendar", "Scholarships" ];

const notices = [
  { date: '30-MAY', title: 'Symposium: Inflation & Fiscal Policy' },
  { date: '20-MAY', title: 'Undergraduate Research Grant Deadline' },
  { date: '12-MAY', title: 'Guest Lecture: Central Bank Operations' },
];

const contact = {
  office: "Room 208, Business Building",
  phone: "+880-1234-567897",
  email: "head_econ@metrouni.edu.bd",
};

// ⬆️ --- END OF DATA PACK --- ⬆️

export default function DataScienceDept() {
