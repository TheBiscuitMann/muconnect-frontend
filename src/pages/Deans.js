...
// ── DEAN IMAGE IMPORTS ──
import masudImg from '../assets/masud_dean.jpg';
import asrafulImg from '../assets/ashraful_dean.jpg'; // Fixed the spelling to add the 'h'
//import anikImg from '../assets/dean.png';
import nazrulImg from '../assets/nazrul_haq.png'; // Removed the // so React can see it!
const NAVY = '#1e2a6e';
const RED  = '#e31e24';
const GREY = '#6b7280';
...
const DEANS = [
  ...
  { 
    name: 'Professor Sheikh Ashrafur Rahaman', 
    title: 'Dean', 
    ...
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", color: NAVY, background: '#fcfcfd', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '80px auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' }}>
          {DEANS.map((dean, i) => (
            <div key={i} style={{
              background: '#fff', border: '1px solid #eaeaea', borderRadius: '20px', padding: '40px 24px',
            ...
            >
              {/* Dean Image */}
              <div style={{ 
                background: '#f8f9fa', borderRadius: '24px', padding: '12px', 
                marginBottom: '24px', width: '160px', height: '160px' 
              }}>
                <img src={dean.img} alt={dean.name} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px' }} />
              </div>
              ...
              <div style={{ width: '32px', height: '3px', background: RED, margin: '0 auto 16px', borderRadius: '2px' }} />
              
              <p style={{ margin: '0 0 6px', fontSize: '15px', color: GREY, fontWeight: '700', textTransform: 'uppercase', letterSpacing: '1px' }}>
                {dean.title}
              </p>
              <p style={{ margin: 0, fontSize: '15px', color: NAVY, fontWeight: '600' }}>
                {dean.school}
              </p>
            </div>
          ))}
