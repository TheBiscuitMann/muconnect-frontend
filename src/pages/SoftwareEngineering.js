...
const DEPT_COLOR = '#0288D1'; // Tech Blue
...
const quickLinks = [ "BSc in Software Engineering", "Agile Development Lab", "GitHub Student Hub", "Capstone Projects", "Academic Calendar" ];

const notices = [
  { date: '25-MAY', title: 'Hackathon 2026: Build for Sustainability' },
  { date: '15-MAY', title: 'Workshop: React & Next.js Architecture' },
  { date: '08-MAY', title: 'Tech Career Fair Registration' },
];

const contact = {
  office: "Room 405, Tech Building",
  phone: "+880-1234-567895",
  email: "head_se@metrouni.edu.bd",
};
