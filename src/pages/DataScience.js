...
import headPic from '../assets/data_dean.png';
...
const deptHead = {
  name: "Md. Mushtaq Shahriar Rafee",
  title: "Head, Department of Data Science",
  message: "Welcome to Data Science at Metropolitan University. In the age of big data, our mission is to train analytical minds to extract meaningful insights from complex systems. Our students master machine learning, statistical modeling, and data engineering to solve the world's most pressing challenges.",
};

const quickLinks = [
  "BSc in Data Science", "Analytics Laboratory", "Kaggle Competitions Hub", "Academic Calendar", "Industry Internships"
];

const notices = [
  { date: '22-MAY', title: 'National Datathon 2026 Registration Open' },
  { date: '18-MAY', title: 'Workshop: Deep Learning with PyTorch' },
  { date: '05-MAY', title: 'Seminar on Ethics in Artificial Intelligence' },
];

const contact = {
  office: "Room 501, Tech Building, Bateshwar Campus",
  phone: "+880-1234-567893",
  email: "head_ds@metrouni.edu.bd",
};
