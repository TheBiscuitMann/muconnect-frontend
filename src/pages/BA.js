...
const DEPT_COLOR = '#F9A825'; // Deep Gold
const DEPT_NAME = 'Business Administration (BA)';
...
const quickLinks = [ "BA Program Overview", "Management Trainee Hub", "Leadership Seminars", "Academic Calendar", "Career Counseling" ];

const notices = [
  { date: '05-JUN', title: 'Workshop: Corporate Communication' },
  { date: '28-MAY', title: 'HR Management Case Study Release' },
  { date: '20-MAY', title: 'Networking Event with Local NGOs' },
];

const contact = {
  office: "Room 202, Business Building",
  phone: "+880-1234-567899",
  email: "head_ba@metrouni.edu.bd",
};
